...
norm3: taking into account the percentage of plasmid 
"""
...
centro_dist['KANMX'] = 0
centro_dist['Pneu300'] = 0
centro_dist['Mmm_Linear_740kb.fa'] = 0
...
sizes_dist['Pneu300'] = 817946
sizes_dist['Mmm_Linear_740kb.fa'] = 1222199
...
#    coverage_plasmid [ np.isnan(coverage_plasmid1)] = np.nan
    ...
    contact_with_plasmid=contact_with_plasmid/perc_plasmid # taking into accournt plasmid presence (norm3)
    contact_with_plasmid1=contact_with_plasmid
