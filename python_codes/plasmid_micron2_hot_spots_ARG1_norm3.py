...
if len(sys.argv) == 4:
        file_size="/home/axel/Bureau/YEAST/agnes_test/sacCer3_with_plasmid_2micron_pRS413/sacCer3.chr_sizes.txt"
...
print("Percentage plasmid")
print(perc_plasmid)

with open('proportions_'+name_bank+'.txt', 'w') as f:
    print('Percentage_plasmid', file=f)
    print(perc_plasmid, file=f)
...
for chr1 in list_chr :
    ...
    coverage_plasmid=coverage_plasmid/perc_plasmid # taking into accournt plasmid presence (norm3)
